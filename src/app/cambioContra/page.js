      ...
      <div className="flex justify-center items-center  pt-8 ">
        ...
        <div className=" px-4 py-1 mt-2">
          <form className="bg-white shadow-md ">
            ...
            {mostrarPregunta && (<div id="pregunta" className="mb-6 space-y-4">
                <div className="block text-gray-700 text-sm mb-4">
                      {pregunta && <p className="text-gray-700">{pregunta}</p>}
                </div>
              <div className="flex items-center justify-center">
            ...
            {mostrarNcontra && (<div id="nuevaContra" className="mb-6 space-y-4">
              <label className="block text-gray-700 text-sm mb-4">
                Nueva Contraseña 
              </label>
              <div className="flex items-center justify-center">
